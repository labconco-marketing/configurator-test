...
@XmlRootElement(name = "GetQueuedStatus")
public class GetQueuedStatus {
    ...
    @XmlElementRef(name = "requestId", namespace = "http://infor.com/pcm/v3", type = JAXBElement.class, required = false)
