...
@XmlRootElement(name = "LoadIntegrationOutputData")
public class LoadIntegrationOutputData {
    ...
    @XmlElementRef(name = "templateId", namespace = "http://infor.com/pcm/v3", type = JAXBElement.class, required = false)
